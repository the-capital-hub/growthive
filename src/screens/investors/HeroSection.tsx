...
const HeroSection: React.FC = () => {
  return (
    <section className="overflow-hidden relative px-5 py-24 text-center max-md:px-5 max-md:py-16">
      <div>
        <p className="mb-2.5 text-3xl">JOIN OUR</p>
        <h2 className="mb-5 text-5xl font-bold max-md:text-6xl lg:text-7xl max-sm:text-3xl">
          Angel Network
        </h2>
        <p className="mx-auto mt-0 mb-8 text-base sm:text-lg md:text-xl font-inter font-medium leading-normal max-w-[800px] max-sm:text-base">
        ...
        <p className="mb-5 text-xl font-inter font-medium">Ready to Shape the Future of Startups?</p>
